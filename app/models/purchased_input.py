...
class PurchasedInput(Base):
    ...
    finance_credit_card = relationship("FinanceCreditCard", back_populates="purchased_inputs")
    finance_transaction = relationship("FinanceTransaction", back_populates="purchased_inputs")
