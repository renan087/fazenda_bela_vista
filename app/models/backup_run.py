...
class BackupRun(Base):
    ...
    deleted_from_storage_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    deleted_from_storage_reason: Mapped[str | None] = mapped_column(String(40), nullable=True)
    deleted_from_storage_source: Mapped[str | None] = mapped_column(String(40), nullable=True)
