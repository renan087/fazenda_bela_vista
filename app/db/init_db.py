...
def _sync_schema() -> None:
    ...
    statements = [
        ...
        CREATE TABLE IF NOT EXISTS equipment_assets (
            ...
            finance_account_id INTEGER REFERENCES finance_accounts(id) ON DELETE SET NULL,
            credit_card_id INTEGER REFERENCES finance_credit_cards(id) ON DELETE SET NULL,
        ...
        CREATE TABLE IF NOT EXISTS finance_credit_cards (
            id SERIAL PRIMARY KEY,
            farm_id INTEGER NOT NULL REFERENCES farms(id) ON DELETE CASCADE,
            payment_account_id INTEGER REFERENCES finance_accounts(id) ON DELETE SET NULL,
        ...
        "ALTER TABLE equipment_assets ADD COLUMN IF NOT EXISTS measurement_label VARCHAR(120)",
        "ALTER TABLE equipment_assets ADD COLUMN IF NOT EXISTS measurement_value NUMERIC(12,2)",
        "ALTER TABLE equipment_assets ADD COLUMN IF NOT EXISTS measurement_unit VARCHAR(30)",
        "ALTER TABLE finance_accounts ADD COLUMN IF NOT EXISTS account_name VARCHAR(180)",
        "ALTER TABLE finance_accounts ADD COLUMN IF NOT EXISTS initial_balance_date DATE",
        ...
        "ALTER TABLE finance_credit_cards ADD COLUMN IF NOT EXISTS card_name VARCHAR(180)",
        "ALTER TABLE finance_credit_cards ADD COLUMN IF NOT EXISTS issuer VARCHAR(120)",
        "ALTER TABLE finance_credit_cards ADD COLUMN IF NOT EXISTS brand VARCHAR(40)",
        "ALTER TABLE finance_credit_cards ADD COLUMN IF NOT EXISTS closing_day INTEGER",
        "ALTER TABLE finance_credit_cards ADD COLUMN IF NOT EXISTS due_day INTEGER",
        ...
        "ALTER TABLE finance_transactions ADD COLUMN IF NOT EXISTS credit_card_id INTEGER REFERENCES finance_credit_cards(id) ON DELETE SET NULL",
        "ALTER TABLE purchased_inputs ADD COLUMN IF NOT EXISTS finance_account_id INTEGER",
        "ALTER TABLE purchased_inputs ADD COLUMN IF NOT EXISTS credit_card_id INTEGER REFERENCES finance_credit_cards(id) ON DELETE SET NULL",
        "ALTER TABLE purchased_inputs ADD COLUMN IF NOT EXISTS finance_transaction_id INTEGER",
        "ALTER TABLE equipment_assets ADD COLUMN IF NOT EXISTS finance_account_id INTEGER",
        "ALTER TABLE equipment_assets ADD COLUMN IF NOT EXISTS credit_card_id INTEGER REFERENCES finance_credit_cards(id) ON DELETE SET NULL",
        "ALTER TABLE equipment_assets ADD COLUMN IF NOT EXISTS finance_transaction_id INTEGER",
        ...
        "ALTER TABLE irrigation_records ADD COLUMN IF NOT EXISTS origin VARCHAR(40) DEFAULT 'manual'",
        ...
        "ALTER TABLE harvest_records ADD COLUMN IF NOT EXISTS responsible_name VARCHAR(160)",
        "ALTER TABLE harvest_records ADD COLUMN IF NOT EXISTS work_shift VARCHAR(30)",
        "ALTER TABLE harvest_records ADD COLUMN IF NOT EXISTS maturation_percentage NUMERIC(5,2)",
        "ALTER TABLE harvest_records ADD COLUMN IF NOT EXISTS impurity_percentage NUMERIC(5,2)",
        "ALTER TABLE harvest_records ADD COLUMN IF NOT EXISTS input_moisture_percentage NUMERIC(5,2)",
        "ALTER TABLE harvest_records ADD COLUMN IF NOT EXISTS volume_count INTEGER",
        ...
        "ALTER TABLE purchased_inputs ADD COLUMN IF NOT EXISTS payment_condition VARCHAR(20) DEFAULT 'a_vista'",
        "ALTER TABLE purchased_inputs ADD COLUMN IF NOT EXISTS payment_method VARCHAR(80)",
        "ALTER TABLE purchased_inputs ADD COLUMN IF NOT EXISTS installment_count INTEGER DEFAULT 1",
        "ALTER TABLE purchased_inputs ADD COLUMN IF NOT EXISTS installment_frequency VARCHAR(20)",
        "ALTER TABLE purchased_inputs ADD COLUMN IF NOT EXISTS first_installment_date DATE",
        "ALTER TABLE equipment_assets ADD COLUMN IF NOT EXISTS payment_condition VARCHAR(20) DEFAULT 'a_vista'",
        "ALTER TABLE equipment_assets ADD COLUMN IF NOT EXISTS payment_method VARCHAR(80)",
        "ALTER TABLE equipment_assets ADD COLUMN IF NOT EXISTS installment_count INTEGER DEFAULT 1",
        "ALTER TABLE equipment_assets ADD COLUMN IF NOT EXISTS installment_frequency VARCHAR(20)",
        "ALTER TABLE equipment_assets ADD COLUMN IF NOT EXISTS first_installment_date DATE",
